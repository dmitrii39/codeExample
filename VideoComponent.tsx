...
const VideoComponent = () => {
  return (
    <View
      ...
      {/* <CustomText style={styles.videotextStyle} textType="Rubik-Italic">
        Details of the above Video.
      </CustomText> */}
      <YouTube
        videoId="uZjhIksrVv4" // The YouTube video ID
